...
export default function Aside({ personalData, setPersonalData }) {
...
function PersonalComponent({ isActive, onShow, data, setData }) {
    console.log(data);
    const onChange = (e) => {
        setData((prev) => {
            console.log(e);
...
function EducationComponent({ isActive, onShow }) {
    return (
        <li>
            <button
                className={`dropdown${isActive ? ' rotate active' : ''}`}
